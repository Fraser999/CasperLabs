...
use casperlabs_types::{
    ...
    encoding, AccessRights, CLTyped, CLValue, Key, URef, U128, U256, U512,
};
...
#[bench]
fn serialize_vector_of_i32s_serde(b: &mut Bencher) {
    let data = prepare_vector(black_box(BATCH));
...
#[bench]
fn deserialize_vector_of_i32s_serde(b: &mut Bencher) {
    let data = prepare_vector(black_box(BATCH)).to_bytes().unwrap();
    b.iter(|| {
...
#[bench]
fn serialize_vector_of_u8_serde(b: &mut Bencher) {
    // 0, 1, ... 254, 255, 0, 1, ...
...
#[bench]
fn deserialize_vector_of_u8_serde(b: &mut Bencher) {
    // 0, 1, ... 254, 255, 0, 1, ...
    let data: Vec<u8> = prepare_vector(BATCH)
        .into_iter()
        .map(|value| value as u8)
...
#[bench]
fn serialize_u8_serde(b: &mut Bencher) {
...
#[bench]
fn deserialize_u8_serde(b: &mut Bencher) {
...
#[bench]
fn serialize_i32_serde(b: &mut Bencher) {
...
#[bench]
fn deserialize_i32_serde(b: &mut Bencher) {
...
#[bench]
fn serialize_u64_serde(b: &mut Bencher) {
...
#[bench]
fn deserialize_u64_serde(b: &mut Bencher) {
    b.iter(|| {
...
#[bench]
fn serialize_some_u64_serde(b: &mut Bencher) {
    let data = Some(14_157_907_845_468_752_670u64);
...
#[bench]
fn deserialize_some_u64_serde(b: &mut Bencher) {
    let data = Some(14_157_907_845_468_752_670u64);
    let data = data.to_bytes().unwrap();
...
#[bench]
fn serialize_none_u64_serde(b: &mut Bencher) {
    let data: Option<u64> = None;
...
#[bench]
fn deserialize_ok_u64_serde(b: &mut Bencher) {
    let data: Option<u64> = None;
    let data = data.to_bytes().unwrap();
...
#[bench]
fn serialize_vector_of_vector_of_u8_serde(b: &mut Bencher) {
...
#[bench]
fn deserialize_vector_of_vector_of_u8_serde(b: &mut Bencher) {
    let data: Vec<u8> = (0..4)
        .map(|_v| {
            // 0, 1, 2, ..., 254, 255
            iter::repeat_with(|| 0..255u8)
...
#[bench]
fn serialize_tree_map_serde(b: &mut Bencher) {
    let data = {
        let mut res = BTreeMap::new();
        res.insert("asdf".to_string(), "zxcv".to_string());
        res.insert("qwer".to_string(), "rewq".to_string());
...
#[bench]
fn deserialize_treemap_serde(b: &mut Bencher) {
    let data = {
        let mut res = BTreeMap::new();
        res.insert("asdf".to_string(), "zxcv".to_string());
        res.insert("qwer".to_string(), "rewq".to_string());
...
#[bench]
fn serialize_string_serde(b: &mut Bencher) {
    let lorem = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.";
    let data = lorem.to_string();
    b.iter(|| encoding::serialize(black_box(&data)));
}
...
#[bench]
fn deserialize_string_serde(b: &mut Bencher) {
    let lorem = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.";
    let data = lorem.to_bytes().unwrap();
...
#[bench]
fn serialize_vec_of_string_serde(b: &mut Bencher) {
    let lorem = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.".to_string();
    let array_of_lorem: Vec<String> = lorem.split(' ').map(Into::into).collect();
    let data = array_of_lorem;
    b.iter(|| encoding::serialize(black_box(&data)));
...
#[bench]
fn deserialize_vec_of_string_serde(b: &mut Bencher) {
    let lorem = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.".to_string();
    let array_of_lorem: Vec<String> = lorem.split(' ').map(Into::into).collect();
    let data = array_of_lorem.to_bytes().unwrap();
...
#[bench]
fn serialize_unit_serde(b: &mut Bencher) {
...
#[bench]
fn deserialize_unit_serde(b: &mut Bencher) {
    let data = ().to_bytes().unwrap();
...
#[bench]
fn serialize_key_account_serde(b: &mut Bencher) {
    let account = Key::Account(PublicKey::ed25519_from([0u8; 32]));
...
#[bench]
fn deserialize_key_account_serde(b: &mut Bencher) {
    let account = Key::Account(PublicKey::ed25519_from([0u8; 32]));
    let account_bytes = account.to_bytes().unwrap();
...
#[bench]
fn serialize_key_hash_serde(b: &mut Bencher) {
    let hash = Key::Hash([0u8; 32]);
...
#[bench]
fn deserialize_key_hash_serde(b: &mut Bencher) {
    let hash = Key::Hash([0u8; 32]);
    let hash_bytes = hash.to_bytes().unwrap();
...
#[bench]
fn serialize_key_uref_serde(b: &mut Bencher) {
    let uref = Key::URef(URef::new([0u8; 32], AccessRights::ADD_WRITE));
...
#[bench]
fn deserialize_key_uref_serde(b: &mut Bencher) {
    let uref = Key::URef(URef::new([0u8; 32], AccessRights::ADD_WRITE));
    let uref_bytes = uref.to_bytes().unwrap();
...
#[bench]
fn serialize_vec_of_keys_serde(b: &mut Bencher) {
    let keys: Vec<Key> = (0..32)
        .map(|i| Key::URef(URef::new([i; 32], AccessRights::ADD_WRITE)))
        .collect();
...
#[bench]
fn deserialize_vec_of_keys_serde(b: &mut Bencher) {
    let keys: Vec<Key> = (0..32)
        .map(|i| Key::URef(URef::new([i; 32], AccessRights::ADD_WRITE)))
        .collect();
    let keys_bytes = keys.to_bytes().unwrap();
...
#[bench]
fn serialize_access_rights_read_serde(b: &mut Bencher) {
...
#[bench]
fn deserialize_access_rights_read_serde(b: &mut Bencher) {
    let data = AccessRights::READ.to_bytes().unwrap();
...
#[bench]
fn serialize_access_rights_write_serde(b: &mut Bencher) {
...
#[bench]
fn deserialize_access_rights_write_serde(b: &mut Bencher) {
    let data = AccessRights::WRITE.to_bytes().unwrap();
    b.iter(|| encoding::deserialize::<AccessRights>(&data));
}
...
#[bench]
fn serialize_access_rights_add_serde(b: &mut Bencher) {
...
#[bench]
fn deserialize_access_rights_add_serde(b: &mut Bencher) {
    let data = AccessRights::ADD.to_bytes().unwrap();
    b.iter(|| encoding::deserialize::<AccessRights>(&data));
}
...
#[bench]
fn serialize_access_rights_read_add_serde(b: &mut Bencher) {
...
#[bench]
fn deserialize_access_rights_read_add_serde(b: &mut Bencher) {
    let data = AccessRights::READ_ADD.to_bytes().unwrap();
    b.iter(|| encoding::deserialize::<AccessRights>(&data));
}
...
#[bench]
fn serialize_access_rights_read_write_serde(b: &mut Bencher) {
...
#[bench]
fn deserialize_access_rights_read_write_serde(b: &mut Bencher) {
    let data = AccessRights::READ_WRITE.to_bytes().unwrap();
    b.iter(|| encoding::deserialize::<AccessRights>(&data));
}
...
#[bench]
fn serialize_access_rights_add_write_serde(b: &mut Bencher) {
...
#[bench]
fn deserialize_access_rights_add_write_serde(b: &mut Bencher) {
    let data = AccessRights::ADD_WRITE.to_bytes().unwrap();
    b.iter(|| encoding::deserialize::<AccessRights>(&data));
}
...
fn serialize_cl_value_serde<T: CLTyped + Serialize>(raw_value: T) -> Vec<u8> {
    encoding::serialize(&CLValue::from_t_serde(raw_value).expect("should create CLValue"))
        .expect("should serialize CLValue")
}
...
fn benchmark_deserialization_serde<T: CLTyped + Serialize + DeserializeOwned>(
    b: &mut Bencher,
    raw_value: T,
) {
    let serialized_value = serialize_cl_value_serde(raw_value);
    b.iter(|| {
        let cl_value: CLValue = encoding::deserialize(&serialized_value).unwrap();
        let _raw_value: T = cl_value.into_t_serde().unwrap();
    });
}
...
#[bench]
fn serialize_cl_value_int32_serde(b: &mut Bencher) {
    b.iter(|| serialize_cl_value_serde(TEST_I32));
}
...
#[bench]
fn deserialize_cl_value_int32_serde(b: &mut Bencher) {
    benchmark_deserialization_serde(b, TEST_I32);
}
...
#[bench]
fn serialize_cl_value_uint128_serde(b: &mut Bencher) {
    b.iter(|| serialize_cl_value_serde(TEST_U128));
}
...
#[bench]
fn deserialize_cl_value_uint128_serde(b: &mut Bencher) {
    benchmark_deserialization_serde(b, TEST_U128);
}
...
#[bench]
fn serialize_cl_value_uint256_serde(b: &mut Bencher) {
    b.iter(|| serialize_cl_value_serde(TEST_U256));
}
...
#[bench]
fn deserialize_cl_value_uint256_serde(b: &mut Bencher) {
    benchmark_deserialization_serde(b, TEST_U256);
}
...
#[bench]
fn serialize_cl_value_uint512_serde(b: &mut Bencher) {
    b.iter(|| serialize_cl_value_serde(TEST_U512));
}
...
#[bench]
fn deserialize_cl_value_uint512_serde(b: &mut Bencher) {
    benchmark_deserialization_serde(b, TEST_U512);
}
...
#[bench]
fn serialize_cl_value_bytearray_serde(b: &mut Bencher) {
    b.iter(|| serialize_cl_value_serde((0..255).collect::<Vec<u8>>()));
}
...
#[bench]
fn deserialize_cl_value_bytearray_serde(b: &mut Bencher) {
    benchmark_deserialization_serde(b, (0..255).collect::<Vec<u8>>());
}
...
#[bench]
fn serialize_cl_value_listint32_serde(b: &mut Bencher) {
    b.iter(|| serialize_cl_value_serde((0..1024).collect::<Vec<i32>>()));
}
...
#[bench]
fn deserialize_cl_value_listint32_serde(b: &mut Bencher) {
    benchmark_deserialization_serde(b, (0..1024).collect::<Vec<i32>>());
}
...
#[bench]
fn serialize_cl_value_string_serde(b: &mut Bencher) {
    b.iter(|| serialize_cl_value_serde(TEST_STR_1.to_string()));
}
...
#[bench]
fn deserialize_cl_value_string_serde(b: &mut Bencher) {
    benchmark_deserialization_serde(b, TEST_STR_1.to_string());
}
...
#[bench]
fn serialize_cl_value_liststring_serde(b: &mut Bencher) {
    b.iter(|| serialize_cl_value_serde(vec![TEST_STR_1.to_string(), TEST_STR_2.to_string()]));
}
...
#[bench]
fn deserialize_cl_value_liststring_serde(b: &mut Bencher) {
    benchmark_deserialization_serde(b, vec![TEST_STR_1.to_string(), TEST_STR_2.to_string()]);
}
...
#[bench]
fn serialize_cl_value_namedkey_serde(b: &mut Bencher) {
    b.iter(|| {
        serialize_cl_value_serde((
            TEST_STR_1.to_string(),
            Key::Account(PublicKey::ed25519_from([0xffu8; 32])),
        ))
    });
...
#[bench]
fn deserialize_cl_value_namedkey_serde(b: &mut Bencher) {
    benchmark_deserialization_serde(
        b,
        (
            TEST_STR_1.to_string(),
            Key::Account(PublicKey::ed25519_from([0xffu8; 32])),
...
#[bench]
fn serialize_u128_serde(b: &mut Bencher) {
    let num_u128 = U128::default();
...
#[bench]
fn deserialize_u128_serde(b: &mut Bencher) {
    let num_u128 = U128::default();
    let num_u128_bytes = num_u128.to_bytes().unwrap();
...
#[bench]
fn serialize_u256_serde(b: &mut Bencher) {
    let num_u256 = U256::default();
...
#[bench]
fn deserialize_u256_serde(b: &mut Bencher) {
    let num_u256 = U256::default();
    let num_u256_bytes = num_u256.to_bytes().unwrap();
...
#[bench]
fn serialize_u512_serde(b: &mut Bencher) {
    let num_u512 = U512::default();
...
#[bench]
fn deserialize_u512_serde(b: &mut Bencher) {
    let num_u512 = U512::default();
    let num_u512_bytes = num_u512.to_bytes().unwrap();
